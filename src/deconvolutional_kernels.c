...
void forward_deconvolutional_layer_gpu(layer l, network_state state)
{
    ...
    for(i = 0; i < l.batch; ++i){
        ...
        gemm_ongpu(1,0,m,n,k,1,a,0,m,b,i*l.c*l.h*l.w,n,0,c,0,n);
...
void backward_deconvolutional_layer_gpu(layer l, network_state state)
{
    ...
    for(i = 0; i < l.batch; ++i){
        ...
        gemm_ongpu(0,1,m,n,k,1,a,i*m*n,k,b,0,k,1,c,0,n);
        ...
        if(state.delta){
            ...
            GPU_DATA a = l.weights_gpu;
            GPU_DATA b = state.workspace_gpu;
            GPU_DATA c = state.delta_gpu;

            gemm_ongpu(0,0,m,n,k,1,a,0,k,b,0,n,1,c,i*n*m,n);
        }
    }
}
